...
public class FileTransferServiceImpl implements FileTransferService {
    ...
    @Override
    public boolean uploadMultipartFile(MultipartFile file, String remothePath) {
        // TODO Auto-generated method stub
        ChannelSftp channelSftp = createChannelSftp();
        try (InputStream inputStream = file.getInputStream()) {
            channelSftp.connect();
            channelSftp.put(inputStream, remothePath);
            return true;
        } catch(Exception e){
            e.printStackTrace();
            throw new OperationErrorException("Ocurrió un error al almacenar el archivo");
        }
